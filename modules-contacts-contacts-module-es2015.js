...
let ContactsComponent = class ContactsComponent {
    constructor(formBuilder, dialog, snackbar, contactsService, notificationsService, dialogService) {
    ...
    // New Customer
    openRepDialog() {
        const dialogRef = this.dialog.open(_rep_dialog_rep_dialog_component__WEBPACK_IMPORTED_MODULE_6__["RepDialogComponent"], {
            width: '250px',
            data: {}
        });
...
let RepDialogComponent = class RepDialogComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
//# sourceMappingURL=modules-contacts-contacts-module-es2015.js.map