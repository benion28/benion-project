...
let AppComponent = class AppComponent {
    constructor(homeService, dialog, userService, timeService) {
...
/* harmony import */ var ng_marquee__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ng-marquee */ "./node_modules/ng-marquee/fesm2015/ng-marquee.js");
...
let AdminNewsComponent = class AdminNewsComponent {
    constructor(topStoriesNews, entertainmentNews, sportsNews, educationNews, technologyNews, notificationsService, dialogService, newsService) {
...
let AdminTodosComponent = class AdminTodosComponent {
    constructor(contactsService, notificationsService, dialogService) {
...
AdminTodosComponent.ctorParameters = () => [
...
let AdminUsersComponent = class AdminUsersComponent {
    constructor(userService, departmentService, dialog, notificationService, dialogService) {
        this.userService = userService;
    ...
    ngOnInit() {
        this.userService.getUsers().subscribe(list => {
            ...
            this.listData = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.array);
...
let HomepageComponent = class HomepageComponent {
    constructor(topStoriesNews, entertainmentNews, sportsNews, educationNews, technologyNews, newsService, dialogService) {
        this.topStoriesNews = topStoriesNews;
        this.entertainmentNews = entertainmentNews;
        this.sportsNews = sportsNews;
        this.educationNews = educationNews;
...
let NewUserComponent = class NewUserComponent {
    constructor(userService, departmentsService, notificationsService, dialogRef) {
        this.userService = userService;
...
let UsersComponent = class UsersComponent {
    ...
    ngOnInit() {
        this.userService.getUsers().subscribe(list => {
            ...
            this.listData = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](this.array);
            this.listData.sort = this.sort;
            this.listData.paginator = this.paginator;
            this.listData.filterPredicate = (data, filter) => {
                return this.displayedColumns.some(element => {
...
let fadeAnimation = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])('fade', [
...
let ContactsService = class ContactsService {
    constructor(firebase) {
        ...
        this.todoList.snapshotChanges().subscribe(list => {
...
let DepartmentsService = class DepartmentsService {
    ...
    getDepartmentName($key) {
        ...
        if ($key === '0') {
            ...
            return lodash__WEBPACK_IMPORTED_MODULE_3__["find"](this.array, (object) => {
...
let EducationService = class EducationService {
    constructor(firebase) {
        ...
        this.educationList.snapshotChanges().subscribe(list => {
...
EntertainmentService.ctorParameters = () => [
    { type: angularfire2_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
];
...
let HomeService = class HomeService {
    constructor(firebase) {
        ...
        this.loginList.snapshotChanges().subscribe(list => {
...
let NewsService = class NewsService {
    constructor(topStoriesNews, entertainmentNews, sportsNews, educationNews, technologyNews) {
        this.topStoriesNews = topStoriesNews;
        this.entertainmentNews = entertainmentNews;
        this.sportsNews = sportsNews;
        this.educationNews = educationNews;
...
TechnologyService.ctorParameters = () => [
    { type: angularfire2_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
];
...
let TopStoriesService = class TopStoriesService {
    constructor(firebase) {
        this.firebase = firebase;
        this.topStories = [];
...
TopStoriesService.ctorParameters = () => [
    { type: angularfire2_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
];
