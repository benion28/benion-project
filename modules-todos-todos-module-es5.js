...
var AboutTodosComponent = /** @class */ (function () {
    function AboutTodosComponent() {
    ...
    AboutTodosComponent.prototype.ngOnInit = function () {
    };
...
var AddTodoComponent = /** @class */ (function () {
    ...
    AddTodoComponent.prototype.onAddItem = function () {
        var todo = {
            title: this.title,
            completed: false
        };
...
var TodosComponent = /** @class */ (function () {
    ...
    TodosComponent.prototype.deleteTodo = function (todo) {
        console.log('Deleted');
        // Delete In UI
        this.todos = this.todos.filter(function (item) { return item.id !== todo.id; });
        // Delete On Server
    ...
    TodosComponent.prototype.addTodo = function (todo) {
        var _this = this;
        this.todoService.addTodo(todo).subscribe(function (item) {
...
//# sourceMappingURL=modules-todos-todos-module-es5.js.map